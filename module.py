...
class MergeLayer(torch.nn.Module):
    def __init__(self, dim1, dim2, dim3, dim4, activation='leakyRelu'):
        super().__init__()
...
class TGAN(torch.nn.Module):
    def __init__(self, ngh_finder, n_feat, e_feat,
                 classification_mode=False, attn_mode='prod', use_time='time', agg_method='attn', node_dim=None, time_dim=None,
